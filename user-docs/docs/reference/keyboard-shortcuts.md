...
| **Ctrl + Shift + L** | Open the Lore Indicator V5 palette when V5 is enabled and the default keybind is active |

!!! note "Configurable lore shortcut"
    The Lore Indicator shortcut can be changed or removed in its productivity
    settings. If the V5 surface is not available in the current build, the
    saved shortcut has no effect.
