...
export default function CharacterBrowser() {
  ...
  const homepageDisplaySettings = useStore((s) => s.homepageCharacterLibrarySettings)
  const characterTabDisplaySettings = useStore((s) => s.characterTabDisplaySettings)
  const resolvedDisplay = useMemo(() => resolveCharacterDisplaySettings({
    surface: 'characters-tab',
    homepageSettings: homepageDisplaySettings,
