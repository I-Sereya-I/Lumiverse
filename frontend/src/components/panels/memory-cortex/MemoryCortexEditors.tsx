...
export function EntityEditorModal({
  ...
  return (
    <ModalShell data-component="MemoryCortexEditors" isOpen onClose={onClose} maxWidth={640}>
...
export function RelationEditorModal({
  ...
  return (
    <ModalShell data-component="MemoryCortexEditors" isOpen onClose={onClose} maxWidth={560}>
      <div className={styles.modalHeader}>
        <Edit2 size={16} />
...
export function ColorEditorModal({
  ...
  return (
    <ModalShell data-component="MemoryCortexEditors" isOpen onClose={onClose} maxWidth={520}>
      <div className={styles.modalHeader}>
