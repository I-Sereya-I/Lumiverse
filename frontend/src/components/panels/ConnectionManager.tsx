...
export default function ConnectionManager() {
  ...
  if (loading) {
    return <div data-component="ConnectionManager" className={styles.loading}>{t('connectionManager.loading')}</div>
  }

  return (
    <div data-component="ConnectionManager" className={styles.manager}>
      {!creating && (
