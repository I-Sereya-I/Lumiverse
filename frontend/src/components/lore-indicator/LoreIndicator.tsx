...
import { DEFAULT_LORE_INDICATOR_SETTINGS } from '@/lib/uiProductivityDefaults'
...
export default function LoreIndicator() {
  ...
  }, [settings.enabled, settings.variant, settings.v5Keybind])
