...
export default function GroupChatCreatorModal() {
  ...
  return (
    <ModalShell data-component="GroupChatCreatorModal" isOpen={true} onClose={closeModal} maxWidth="clamp(340px, 94vw, min(760px, var(--lumiverse-content-max-width, 760px)))" className={styles.modal}>
