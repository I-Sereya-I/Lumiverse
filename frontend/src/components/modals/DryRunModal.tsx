...
export default function DryRunModal() {
  ...
  return (
    <ModalShell data-component="DryRunModal" isOpen={true} onClose={closeModal} maxWidth="clamp(340px, 94vw, min(1100px, var(--lumiverse-content-max-width, 1100px)))" className={styles.modal}>
          {/* Header */}
