...
export default function ManageChatsModal() {
  ...
  return (
    <>
    <ModalShell data-component="ManageChatsModal" isOpen={true} onClose={closeModal} closeOnEscape={false} maxWidth="clamp(340px, 94vw, min(560px, var(--lumiverse-content-max-width, 560px)))" className={styles.modal}>
