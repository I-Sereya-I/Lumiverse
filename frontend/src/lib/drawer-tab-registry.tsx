...
import {
  ...
  GitBranch, Globe, Wallpaper, Replace, Library, Feather, Database, BookOpen,
} from 'lucide-react'
...
export const DRAWER_TABS: DrawerTabEntry[] = [
  ...
  },
  {
    id: 'worldinfo',
    shortName: 'Lore',
    tabName: 'Activated Lore',
    tabDescription: 'Inspect the exact lore activation trace',
    tabIcon: BookOpen,
    tabHeaderTitle: 'Activated Lore',
    keywords: ['lore', 'world info', 'activation', 'trace', 'lorebook', 'active', 'entries', 'triggered', 'wi', 'matched', 'fired'],
