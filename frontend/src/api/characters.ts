...
export const charactersApi = {
  ...
  listSummaries(params?: SummaryParams, signal?: AbortSignal) {
    return get<PaginatedResult<CharacterSummary>>('/characters/summary', params, { signal })
  },

  getHomepagePreview(id: string, signal?: AbortSignal) {
    return get<CharacterPreview>(`/characters/${id}/homepage-preview`, undefined, { signal })
  },
